...
def main(input_text, _=None):
    ...
    print(f"Translation process finished. Total Translation time: {translation_time}")
    ...
    def classify_direction(question):
        ...
        print(f"Routing process finished. Total Routing time: {routing_time}")
        return question, direction
    ...
    ####TO DO: No fallback to RAG
        ...
        print(f"SQL process finished. Total SQL time: {sql_time}")
        return result, fullresult 
    ...
    def apipipe(question):
        ...
        try:
            ...
            print(f"API process finished. Total API time: {api_time}")
            return result, fullapiresult
    ...
    def ragpipe(query):
        ...
        print(f"RAG process finished. Total RAG time: {rag_time}")
    ...
    def nl_answer(question, result, lang):
        ...
        print(f"Generating Answer in Natural Language finished. Total Generation time: {answer_time}")
        return result
